...
handle lightweight operations that do not require a gateway round-trip, such as simple lookups,
...
\section{Step 2: Load gateway tools over MCP}
...
\section{Step 3: Encode operating procedures in SKILL.md}
...
\section{Step 4: Build the Strands agent}
...
\section{Step 5: Build the LangGraph agent}
...
loop: model call, tool call, observation, repeat. However, every part of the loop can be
...
\section{Step 6: The entrypoint and session identity}
...
\section{Step 7: The full picture}
