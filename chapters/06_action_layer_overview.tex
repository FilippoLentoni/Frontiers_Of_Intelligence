...
decorator pattern used later in the implementation chapters. The name is unambiguous, the description
...
the agent is granted. Read tools, including search, retrieval, inspection, calculation, carry no
...
When a subtask is sufficiently complex to warrant its own reasoning loop, such as a research
