...
incorporated into subsequent reasoning. Orthogonal to both are efficiency scores---whether 
...
this traffic would leave the most informative cases---those where the agent visibly 
