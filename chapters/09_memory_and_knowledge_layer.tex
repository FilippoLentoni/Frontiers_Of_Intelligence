...
the moment of decision. Its function is context engineering: given a task, the layer must
construct the context window with the subset of available information that is most
relevant, most current, and most likely to support a correct and grounded response.
...
manuals, tickets, and databases. Both must pass through the same context engineering
