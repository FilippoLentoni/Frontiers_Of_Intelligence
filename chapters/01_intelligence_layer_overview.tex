...
make it useful: tools, memory, security controls, evaluation loops, and deployment
machinery. The foundation model provides the core reasoning and generation capability,
but the system acquires operational utility only when that capability is connected to
context, actions, and governance. This book is organised around a decomposition of that
architecture into four layers: the intelligence layer, the action layer, the memory and
...
servers, browser automation, code execution, and agent-as-tool patterns. Some tools are
deterministic---a calculator, a database query, an inventory lookup---while others are
...
generation, knowledge bases, documents, vector stores, context engineering, and reusable
...
The book concludes with the organisational model required to build and sustain an
AI-first company: the teams, processes, and governance structures that allow the
technical architecture to operate reliably at scale.